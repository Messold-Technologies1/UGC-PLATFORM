    ...
    <div className="bg-grain text-foreground bg-background overflow-x-clip">
      ...
      <section className={cn("px-6", sectionPadY)}>
        <div className="mx-auto max-w-[1240px]">
          <h2 className="font-heading mb-[clamp(40px,5vw,60px)] max-w-[600px] text-[clamp(1.9rem,3.4vw,2.9rem)] leading-[1.08] font-bold tracking-[-0.03em] text-balance">
            Everything you normally ask a creator. Already answered.
          </h2>
          <div className="grid items-start gap-[clamp(32px,4vw,56px)] lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div>
              <div className="grid gap-x-[clamp(28px,4vw,56px)] md:grid-cols-2">
                {ANSWERED.map((a) => (
                  <div
                    key={a}
