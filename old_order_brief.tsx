          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <SectionCard title="Creative" icon={Video}>
              <div className="space-y-5">
                <BriefField
                  label="Duration"
                  value={brief.durationBucket ? formatDuration(brief.durationBucket) : "ΓÇö"}
                />
                <BriefField
                  label="Tone"
                ...
                <BriefField
                  label="Location"
                  value={brief.shootLocationKind ? formatLocation(brief.shootLocationKind) : "ΓÇö"}
                />
