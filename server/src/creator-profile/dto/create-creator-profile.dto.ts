...
export class CreateCreatorProfileDto {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Non-language facet selections (catalog slugs per dimension). Use profileLanguages for LANGUAGE. Dimensions: CONTENT_CATEGORY, CREATOR_TYPE, OCCUPATION, APPEARANCE.',
  })
  @IsOptional()
  @IsArray()
