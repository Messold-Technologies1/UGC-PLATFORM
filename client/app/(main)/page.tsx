...
const features = [
  {
    icon: Zap,
    title: "Fast Matching",
    description: "Our algorithm connects brands with the perfect creators in minutes, not days.",
  },
  {
    icon: Shield,
    title: "Secure Payments",
    description: "Escrow-protected payments ensure creators get paid and brands get quality content.",
  },
  {
    icon: TrendingUp,
    title: "Performance Tracking",
    description: "Real-time analytics on content performance, engagement, and ROI.",
  },
  {
    icon: Users,
    title: "Vetted Creators",
    description: "Every creator is verified and reviewed to ensure professional-quality content.",
  },
];
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Where{" "}
              <span className="underline decoration-2 underline-offset-4">Creators</span>
              {" "}Meet{" "}
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/signup">
                <Button size="lg" className="w-full gap-2 bg-foreground border-0 text-background hover:opacity-90 sm:w-auto">
                  Get Started Free
      ...
      <section className="mx-auto max-w-[1440px] px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <span className="underline decoration-2 underline-offset-4">scale UGC</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            From discovery to delivery, we handle every step of the UGC workflow.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-8 sm:p-10">
            ...
            <div className="relative">
              ...
              <Link href="/creator/dashboard" className="mt-8 block">
                <Button size="lg" className="w-full gap-2 bg-foreground border-0 text-background hover:opacity-90">
                  Join as Creator
                  <ArrowRight className="size-4" />
                </Button>
              </Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 py-20 text-center sm:px-6 lg:px-8">
          ...
          <Link href="/signup" className="mt-8 inline-block">
            <Button size="lg" className="gap-2 bg-background text-foreground hover:bg-background/90 border-0">
              Start for Free
              <ArrowRight className="size-4" />
            </Button>
          </Link>
